    ...
    private void tampilkanPilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                ...
                String lokasiRs = "google.navigation:1=0.503573, 101.476618999";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(lokasiRs));
            } else if (pilihan.equals("Website")) {
                String webAB = "https://www.ekahospital.com/id/eka-hospital-pekanbaru/sekilas-tentang-ekahospital-pekanbaru";
