...
public class PolrestaPekan extends ListActivity {
    ...
    private void tampilkanPilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                ...
                String lokasiRs = "google.navigation:1=0.533444774286, 101.443256195";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(lokasiRs));
            } else if (pilihan.equals("Website")) {
                String webAB = "https://www.polrestapekanbaru.com/";
