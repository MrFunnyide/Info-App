...
public class PolsekPekanBaru extends ListActivity {
    ...
    private void tampilkanPilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                ...
                String lokasiRs = "google.navigation:1=0.520367, 101.448861";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(lokasiRs));
            } else if (pilihan.equals("Website")) {
                String webAB = "https://www.tribunnews.com/tag/polsek-pekanbaru-kota";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(webAB));
            } else if (pilihan.equals("Info Google")) {
                a = new Intent(Intent.ACTION_WEB_SEARCH);
                a.putExtra(SearchManager.QUERY, "Polse Pekan Baru");
