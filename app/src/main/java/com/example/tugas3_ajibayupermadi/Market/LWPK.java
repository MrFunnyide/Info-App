...
public class LWPK extends ListActivity {
    ...
    private void tampilkanPilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                String noHP = "tel:0761-6706100";
                a = new Intent(Intent.ACTION_DIAL, Uri.parse(noHP));
            } else if (pilihan.equals("SMS Center")) {
                String textSMS = "Aji Bayu Permadi H/L";
                a = new Intent(Intent.ACTION_VIEW);
                a.setData(Uri.parse("sms:0761-6706100"));
                a.putExtra("sms_body", textSMS);
            } else if (pilihan.equals("Driving Direction")) {
                String lokasiRs = "google.navigation:1=0.5002369, 101.4201878";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(lokasiRs));
            } else if (pilihan.equals("Website")) {
                String webAB = "https://livingworld.co.id/directory/";
